...
def create_scatter_plot(data):
    ...
    # TODO: Create a scatter plot with Hours on x-axis and Scores on y-axis, Use color='purple' and alpha=0.6
    plt.scatter(data['Hours Studied'], data['Test Scores'], color='purple', alpha=0.6)
    # TODO: Add x-axis label: 'Hours Studied'
    plt.xlabel('Number of Hours Studied (Hrs)', fontsize=12)
    # TODO: Add y-axis label: 'Test Score'
    plt.ylabel('Test Scores (%) ', fontsize=12)
    # TODO: Add title: 'Student Test Scores vs Hours Studied'
    plt.title('# of Study Hours vs Test Scores', fontsize=14, fontweight='bold')
...
def evaluate_model(model, X_test, y_test):
    ...
    print(f"  → Interpretation: On average, predictions are off by {rmse:.2f} Point(s)")
...
def visualize_results(X_train, y_train, X_test, y_test, predictions, model):
    ...
    # TODO: Create and plot the line of best fit; Hint: Create a range of X values, predict Y values, then plot as a black line
    ...
    plt.xlabel('Number of Study Hours (Hr)', fontsize=12)
    plt.ylabel('Test Scores (x/100)', fontsize=12)
...
def make_prediction(model, hours):
    ...
    print(f"\n=== New Prediction ===")
    print(f"If the number of study hours is {hours} hours, the predicted test score is: ${predicted_score:.2f}")
